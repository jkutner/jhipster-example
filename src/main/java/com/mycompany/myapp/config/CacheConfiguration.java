    ...
    public CacheManager cacheManager(JHipsterProperties jHipsterProperties) {
        ...
        for (EntityType<?> entity : entities) {
            ...
            if (cache != null) {
                ...
                log.info("EHCACHE! getBootstrapCacheLoader: " + cache.getBootstrapCacheLoader() );
                if (cache.getBootstrapCacheLoader() != null) {
                    log.info("EHCACHE! isAsync: " + cache.getBootstrapCacheLoader().isAsynchronous());
                }
